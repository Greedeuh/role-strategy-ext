...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/root/eclipse-workspace/role-strategy-ext");
    parameters.put("artifactId","role-strategy-ext");
    parameters.put("outputDirectory","/root/eclipse-workspace/role-strategy-ext/target/classes");
    parameters.put("testOutputDirectory","/root/eclipse-workspace/role-strategy-ext/target/test-classes");
